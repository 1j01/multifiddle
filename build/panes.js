...
(function() {
  ...
  this.PanesPane = (function(superClass) {
    ...
    PanesPane.prototype.layout = function() {
      var _col_row, _d1, _d1_end, _d1_start, _d2, _d2_end, _d2_start, _mouse_d1, _mouse_d2, after, before, child_pane, child_pane_size, display, i, j, k, len, n_children, n_resizers, o, parent_pane, ref, ref1, results, space_to_distribute_in_d1;
      parent_pane = this;
      o = this.orientation;
      display = {
        x: "inline-block",
      ...
      results = [];
      for (i = k = 1, ref1 = parent_pane.children.length - 1; 1 <= ref1 ? k <= ref1 : k >= ref1; i = 1 <= ref1 ? ++k : --k) {
        ...
        results.push((function(before, after) {
          ...
          $resizer.on("mousedown", function(e, synthetic) {
            ...
            mousemove = function(e) {
              var after_end, b, before_start, l, len1, mouse_pos, pane, ref2, results1, total_size;
